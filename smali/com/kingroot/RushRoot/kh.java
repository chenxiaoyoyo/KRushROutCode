package com.kingroot.RushRoot; class kh { void a() { int a;
a=0;// .class public final Lcom/kingroot/RushRoot/kh;
...
a=0;//     :cond_0
a=0;//     #v4=(Conflicted);
a=0;//     sput-object v2, Lcom/kingroot/RushRoot/kh;->a:[B
a=0;// 
a=0;//     .line 382
a=0;//     sput-object v3, Lcom/kingroot/RushRoot/kh;->b:[B
a=0;// 
a=0;//     .line 383
a=0;//     return-void
a=0;// 
