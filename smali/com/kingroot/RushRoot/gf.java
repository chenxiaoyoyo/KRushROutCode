package com.kingroot.RushRoot; class gf { void a() { int a;
a=0;// .class Lcom/kingroot/RushRoot/gf;
...
a=0;// 
a=0;// .field d:Lcom/kingroot/RushRoot/hf;
a=0;// 
...
a=0;// 
a=0;//     .line 20
a=0;//     #p0=(Reference,Lcom/kingroot/RushRoot/gf;);
...
a=0;//     iput-object v0, p0, Lcom/kingroot/RushRoot/gf;->a:Ljava/util/HashMap;
a=0;// 
a=0;//     .line 25
a=0;//     new-instance v0, Ljava/util/HashMap;
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Ljava/util/HashMap;);
a=0;//     iput-object v0, p0, Lcom/kingroot/RushRoot/gf;->b:Ljava/util/HashMap;
a=0;// 
a=0;//     .line 29
a=0;//     new-instance v0, Ljava/util/HashMap;
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Ljava/util/HashMap;);
a=0;//     iput-object v0, p0, Lcom/kingroot/RushRoot/gf;->e:Ljava/util/HashMap;
a=0;// 
a=0;//     .line 32
a=0;//     const-string v0, "GBK"
a=0;// 
a=0;//     iput-object v0, p0, Lcom/kingroot/RushRoot/gf;->c:Ljava/lang/String;
a=0;// 
a=0;//     .line 34
...
a=0;//     iput-object v0, p0, Lcom/kingroot/RushRoot/gf;->d:Lcom/kingroot/RushRoot/hf;
a=0;// 
a=0;//     .line 18
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 49
a=0;//     iput-object p1, p0, Lcom/kingroot/RushRoot/gf;->c:Ljava/lang/String;
a=0;// 
a=0;//     .line 50
a=0;//     return-void
a=0;// .end method
...
a=0;//     iget-object v1, p0, Lcom/kingroot/RushRoot/gf;->c:Ljava/lang/String;
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;//     invoke-static {v2, p2}, Lcom/kingroot/RushRoot/gf;->a(Ljava/util/ArrayList;Ljava/lang/Object;)V
a=0;// 
a=0;//     .line 102
a=0;//     invoke-static {v2}, Lcom/kingroot/RushRoot/gd;->a(Ljava/util/ArrayList;)Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     .line 104
a=0;//     iget-object v0, p0, Lcom/kingroot/RushRoot/gf;->e:Ljava/util/HashMap;
a=0;// 
a=0;//     invoke-virtual {v0, p1}, Ljava/util/HashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
a=0;// 
a=0;//     .line 105
a=0;//     iget-object v0, p0, Lcom/kingroot/RushRoot/gf;->a:Ljava/util/HashMap;
a=0;// 
...
a=0;//     .line 328
a=0;//     #v4=(Null);
a=0;//     iget-object v0, p0, Lcom/kingroot/RushRoot/gf;->d:Lcom/kingroot/RushRoot/hf;
a=0;// 
a=0;//     #v0=(Reference,Lcom/kingroot/RushRoot/hf;);
...
a=0;// 
a=0;//     .line 334
a=0;//     iget-object v1, p0, Lcom/kingroot/RushRoot/gf;->d:Lcom/kingroot/RushRoot/hf;
a=0;// 
a=0;//     invoke-virtual {v1, v0, v4, v4}, Lcom/kingroot/RushRoot/hf;->a(Ljava/util/Map;IZ)Ljava/util/HashMap;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Lcom/kingroot/RushRoot/gf;->a:Ljava/util/HashMap;
...
a=0;// 
a=0;//     .line 323
a=0;//     iget-object v1, p0, Lcom/kingroot/RushRoot/gf;->a:Ljava/util/HashMap;
a=0;// 
